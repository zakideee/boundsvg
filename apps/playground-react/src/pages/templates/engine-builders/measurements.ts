...
import { FA, formatPx } from "../../shared/flow-rendering";

export function buildMeasurementsVNode(engine: Engine): VNode {
  ...
  const richPreviewWidth = richPreview.status === "satisfied" ? (richPreview.usedWidth ?? 96) : 96;
