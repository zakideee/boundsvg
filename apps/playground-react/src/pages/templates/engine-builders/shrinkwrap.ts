...
function buildEnglishSection(engine: Engine, children: VNode[], yBase: number): void {
  const fontSize = 12;
...
function buildRubySection(engine: Engine, children: VNode[], xBase: number, yBase: number): void {
  const fontSize = 14;
...
export function buildShrinkwrapVNode(engine: Engine): VNode {
  ...
  buildEnglishSection(engine, children, 40);
  buildRubySection(engine, children, 270, 40);
  buildVerticalSection(engine, children, 640, 40);
