...
const DOCUMENT_TIMELINE_DURATION_MS = 2_400;
const DOCUMENT_TIMELINE_POSTER_MS = 600;

const DOCUMENT_TIMELINE_FAST_TRACK = {
  keyframes: [
...
const DOCUMENT_TIMELINE_SLOW_TRACK = {
  keyframes: [
    { at: 0, opacity: 0.35, transform: { translateX: 0 } },
    { at: 0.5, opacity: 1, transform: { translateX: 620 } },
    { at: 1, opacity: 0.35, transform: { translateX: 0 } },
  ...
  return toVNode(
    <Canvas width={920} height={420} background="#0b1120">
      ...
      <Box
        ...
        borderRadius={12}
        opacity={0.35}
        animate={DOCUMENT_TIMELINE_FAST_TRACK}
      />
      <Box
        position="absolute"
        left={128}
      ...
      <Box
        ...
        borderRadius={12}
        opacity={0.35}
        animate={DOCUMENT_TIMELINE_SLOW_TRACK}
      />
      <Text
        position="absolute"
        left={32}
...
export const TEXT_MOTION_TEMPLATE_DEFINITIONS = {
  "animated-svg-timeline": {
    ...
    vnode: buildAnimatedSvgTimeline(),
    animatedSvgOptions: {
      playback: {
        mode: "timeline",
        durationMs: DOCUMENT_TIMELINE_DURATION_MS,
        iterations: "infinite",
      },
      timeMs: DOCUMENT_TIMELINE_POSTER_MS,
      reducedMotion: "pause",
    },
  },
  "typing-ime-timeline": {
