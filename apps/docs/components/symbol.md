...
Parameterized geometry instance resolved through the engine symbol registry.
...
| --------------------- | -------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `symbol`              | `SymbolDefinition`                           | Either   | Inline symbol definition                                                                                                                                                     |
| `symbolId`            | `string`                                     | Either   | Engine registry key for a preloaded symbol                                                                                                                                   |
...
| `preserveAspectRatio` | `"none" \| "meet" \| "slice"`                |          | How to fit the symbol into the display box                                                                                                                                   |
...
<!--@include: ../_generated/symbol-registered.md-->
