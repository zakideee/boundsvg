...
| Declarative animation (`animate`)         | Supported     | Opacity and center-pivot transform only, with cubic, step, and spring easing. Emitted SVG and sampled still bytes are deterministic; viewer playback timing is outside the contract. Non-CSS viewers show the `timeMs` still. |
...
| Capability                                        | Status       | Notes                                                                                              |
| ------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------- |
| SVG output (text as glyph paths)                  | Supported    | See [Determinism Contract](/reference/determinism)                                                 |
